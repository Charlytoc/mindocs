...
# from server.models import Asset  # Ajusta el import según tu estructura
# import traceback
...
# def extract_and_update_attachments_text(workflow_execution_id: str):
...
#                 select(Asset).where(
#                     Asset.workflow_execution_id == workflow_execution_id
#                 )
#             )
#             attachments = attachments.scalars().all()
#             if not attachments:
#                 printer.yellow(
#                     f"No se encontraron attachments para el caso {workflow_execution_id}"
#                 )
#                 return
